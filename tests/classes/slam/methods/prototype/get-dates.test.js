...
test("returns an empty array when \"from\" is set to \"2018-10-10\"" +
	"\nand \"to\" is set to \"2018-12-31\"", (t) => {
	const testDates = testSlam.getDates("2018-10-10", "2018-12-31");
...
test("returns an empty array when \"from\" is set to \"2018-10-10\"," +
	"\n\"to\" is set to \"2018-12-31\"" +
	"\nand \"amount\" is set to 1", (t) => {
	const testDates = testSlam.getDates("2018-10-10", "2018-12-31", 1);
